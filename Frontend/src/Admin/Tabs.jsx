...
const Tabs = () => {
  ...
  return (
    <>
      <Header />
      {
        admin? <div className="flex  items-center justify-between p-8 space-y-4">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-xl border-[2px] border-pink-500 text-pink-500 ${activeTab === "pending" ? "bg-pink-500 text-white" : "bg-white"
                }`}
            >
              Pending
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-xl border-[2px] border-pink-500 text-pink-500 ${activeTab === "history" ? "bg-pink-500 text-white" : "bg-white"
                }`}
            >
              History
            </button>
