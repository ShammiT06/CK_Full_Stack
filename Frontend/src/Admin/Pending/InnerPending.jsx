...
useEffect(()=>{
      auth.onAuthStateChanged((user)=>{
        if(user)
        {
          ...
          {
            console.log("He is not an super admin")
          }
        }
...
if (!vendor) return <div className="p-4 text-red-500">Vendor not found</div>;
  ...
  return (
    <div className="scroll inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4">
      {
        admin? <div className="bg-[#FAFAFA] relative rounded-xl my-auto shadow-lg max-w-5xl w-full grid md:grid-cols-2 gap-6 p-8">
        <div>
          ...
          <div className="space-y-4 mt-10">
            ...
            <div>
              <label className="block text-md font-medium mb-1">Shop Name</label>
              <input
                type="text"
                className="w-full p-3 border rounded-xl"
            ...
            <div>
              <label className="block text-md font-medium mb-1">Lattitude</label>
              <input
                type="text"
                className="w-full p-3 border rounded-xl"
            ...
            <div>
              <label className="block text-md font-medium mb-1">Longitude</label>
              <input
                type="text"
                className="w-full p-3 border rounded-xl"
        ...
        <div className="flex flex-col mt-20 items-center">
          ...
          <img
            src={vendor.image}
            alt="Preview"
            className="rounded border object-cover size-24 cursor-pointer hover:scale-105 transition duration-300"
            onClick={handleclick}
          />
        </div>
        {isZoomed && (
      ...
      </div>: <div className="bg-[#FAFAFA] relative rounded-xl my-auto shadow-lg max-w-5xl w-full grid md:grid-cols-2 gap-6 p-8">
        <div>
          <h2 className="text-2xl font-semibold bg-gradient-to-b from-[#F04471] to-[#925AC6] bg-clip-text text-transparent text-pink-600 mb-4 w-full">
            {vendor.name} - {vendor.referenceid}
          </h2>
